...
Let's simulate some data to make things more concrete. 


### Simulating stimulus structure

We are going to simulate an experiment where there are 100 stimuli, and the relationships among those stimuli express a graded similarity structure. The expectation is that the neural representations of these stimuli will express this similarity structure

The motivation for RSA is that the stimuli 

First, I will generate the "true structure": three independent dimensions of variability that characterize 100 items.
...
In summary, we have a matrix `X` of simulated fMRI data.
